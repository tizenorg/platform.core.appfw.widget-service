...
widget_instance_h widget_instance_get_instance(const char *widget_id, const char *instance_id)
{
	...
	/* TODO */
	/* on 2.x, any application can access to instance's data without privileges */
	/* for 2.x compatibility, we may have to access instance DB here */
...
int widget_instance_get_instance_list(const char *widget_id, widget_instance_list_cb cb, void *data)
{
	...
	return 0;
	/* TODO */
	/* for 2.x compatibility, we may have to provide instance list withouht privileges */
}
