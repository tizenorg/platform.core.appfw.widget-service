...
static int _get_widget_supported_sizes_real(const char *widget_id, uid_t uid,
		int *cnt, int **w, int **h)
{
		...
		int **w, int **h)
{
	...
	ret = _get_widget_supported_sizes_real(widget_id, getuid(), cnt, w, h);
	if (ret == WIDGET_ERROR_NOT_EXIST)
		ret = _get_widget_supported_sizes_real(widget_id,
				GLOBALAPP_USER, cnt, w, h);
...
static int _widget_service_get_widget_list_real(const char *pkgid, uid_t uid,
		GHashTable *list)
{
	static const char query[] =
...
EAPI int widget_service_get_widget_list(widget_list_cb cb, void *data)
{
	...
	ret = _widget_service_get_widget_list_real(NULL, getuid(), list);
	if (ret == WIDGET_ERROR_NONE)
		ret = _widget_service_get_widget_list_real(NULL,
				GLOBALAPP_USER, list);
	...
	while (g_hash_table_iter_next(&iter, (gpointer *)&classid,
				(gpointer *)&pkgid)) {
		/* TODO: get 'is_prime' */
		if (cb(classid, pkgid, 0, data) != WIDGET_ERROR_NONE)
			break;
	}
		...
		widget_list_by_pkgid_cb cb, void *data)
{
	...
	ret = _widget_service_get_widget_list_real(pkgid, getuid(), list);
	if (ret == WIDGET_ERROR_NONE)
		ret = _widget_service_get_widget_list_real(pkgid,
				GLOBALAPP_USER, list);
...
static char *_widget_service_get_main_app_id_real(const char *widget_id,
		uid_t uid)
{
	static const char query[] =
...
EAPI char *widget_service_get_main_app_id(const char *widget_id)
{
	...
	appid = _widget_service_get_main_app_id_real(widget_id, getuid());
	if (appid == NULL && get_last_result() == WIDGET_ERROR_NOT_EXIST)
		appid = _widget_service_get_main_app_id_real(widget_id,
				GLOBALAPP_USER);
...
static char *_widget_service_get_app_id_of_setup_app_real(const char *widget_id,
		uid_t uid)
{
	static const char query[] =
...
EAPI char *widget_service_get_app_id_of_setup_app(const char *widget_id)
{
	...
	appid = _widget_service_get_app_id_of_setup_app_real(widget_id,
			getuid());
	if (appid == NULL && get_last_result() == WIDGET_ERROR_NOT_EXIST)
		appid = _widget_service_get_app_id_of_setup_app_real(widget_id,
				GLOBALAPP_USER);
...
static bool _widget_service_get_nodisplay_real(const char *widget_id, uid_t uid)
{
	static const char query[] =
...
EAPI int widget_service_get_nodisplay(const char *widget_id)
{
	...
	nodisplay = _widget_service_get_nodisplay_real(widget_id, getuid());
	if (get_last_result() == WIDGET_ERROR_NOT_EXIST)
		nodisplay = _widget_service_get_nodisplay_real(widget_id,
				GLOBALAPP_USER);
...
static char *_widget_service_get_preview_image_path_real(const char *widget_id,
		int width, int height, uid_t uid)
{
	static const char query[] =
		...
		widget_size_type_e size_type)
{
	...
	path = _widget_service_get_preview_image_path_real(widget_id,
			w, h, getuid());
...
static char *_widget_service_get_icon_real(const char *widget_id,
		const char *lang, uid_t uid)
{
	static const char query[] =
...
EAPI char *widget_service_get_icon(const char *widget_id, const char *lang)
{
	...
	icon = _widget_service_get_icon_real(widget_id, lang, getuid());
	if (icon == NULL && get_last_result() == WIDGET_ERROR_NOT_EXIST)
		icon = _widget_service_get_icon_real(widget_id, lang,
				GLOBALAPP_USER);

	return icon;
}

static char *_widget_service_get_name_real(const char *widget_id,
		const char *lang, uid_t uid)
{
	static const char query[] =
...
EAPI char *widget_service_get_name(const char *widget_id, const char *lang)
{
	...
	name = _widget_service_get_name_real(widget_id, lang, getuid());
	if (name == NULL && get_last_result() == WIDGET_ERROR_NOT_EXIST)
		name = _widget_service_get_name_real(widget_id, lang,
				GLOBALAPP_USER);
...
static char *_widget_service_get_widget_id_real(const char *appid, uid_t uid)
{
	static const char query[] =
...
EAPI char *widget_service_get_widget_id(const char *appid)
{
	...
	classid = _widget_service_get_widget_id_real(appid, getuid());
	if (classid == NULL && get_last_result() == WIDGET_ERROR_NOT_EXIST)
		classid = _widget_service_get_widget_id_real(appid,
				GLOBALAPP_USER);

	return classid;
}

static char *_widget_service_get_package_id_real(const char *widget_id,
		uid_t uid)
{
	static const char query[] =
		"SELECT pkgid FROM widget_class WHERE classid=?";
...
EAPI char *widget_service_get_package_id(const char *widget_id)
{
	...
	pkgid = _widget_service_get_package_id_real(widget_id, getuid());
	if (pkgid == NULL && get_last_result() == WIDGET_ERROR_NOT_EXIST)
		pkgid = _widget_service_get_package_id_real(widget_id,
				GLOBALAPP_USER);
