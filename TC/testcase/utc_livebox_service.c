...
#define TWITTER_APP "com.samsung.twitter"
#define TWITTER_FIRENDS_LIVEBOX "com.samsung.twitter.dbox.friends"
#define TWITTER_TWEET_LIVEBOX "com.samsung.twitter.dbox.tweet"
